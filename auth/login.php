...
if (isset($_POST['login'])) {
    ...
    if (mysqli_num_rows($queryLogin) === 1) {
        $rows = mysqli_fetch_assoc($queryLogin);
...
<head>
  ...
  <!-- favicon -->
  <link rel="shortcut icon" href="<?= $main_url ?>asset/image/snackinaja.jpg" type="image/x-icon">
...
<div class="login-box slide-down" style="margin-top: -70px;">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>SNACKINAJA</b></a>
    </div>
    <div class="card-body">
      ...
      <p class="my-3 text-center">
         <strong>Copyright &copy; 2025 <span class="text-info"></span></strong>
    </div>
    <!-- /.card-body -->
  </div>
  <!-- /.card -->
