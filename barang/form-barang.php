                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="satuan" id="satuan" class="form-control" required>
                                <?php 
                                if ($msg != "") {
                                    $satuan = ["gram", "kilo gram", "botol", "kaleng", "bal"];
                                    ...
                                    <option value="bal">bal(10kg)</option>
                                <?php
                                }
                                ?>
                        ...
                        <div class="col-lg-4 text-center px-3">
                            ...
                            <img src="<?= $main_url ?>asset/image/<?= $msg != '' ? $barang['gambar'] : 'barang.jpg' ?>" class="profile-user-img mb-3 mt-4" alt="">
